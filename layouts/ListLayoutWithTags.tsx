...
import type { Writings } from 'contentlayer/generated'
...
interface ListLayoutProps {
  posts: CoreContent<Writings>[]
  title: string
  initialDisplayPosts?: CoreContent<Writings>[]
                  ...
                  return (
                    <li key={t} className="my-3">
                      {pathname.split('/tags/')[1] === slug(t) ? (
                        <h3 className="inline py-2 px-3 uppercase text-sm font-bold dark:text-primary-500 text-gray-900 drop-shadow-at dark:text-primary-500  hover:text-primary-600 dark:hover:text-primary-500">
                          {`${t} (${tagCounts[t]})`}
                        </h3>
                      ) : (
                        <Link
                          href={`/tags/${slug(t)}`}
                          className="py-2 px-3 uppercase text-sm font-medium text-gray-500  dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-500"
